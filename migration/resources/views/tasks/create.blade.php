...
<body class="bg-gray-50 min-h-screen py-8 relative">
    ...
    <div class="absolute top-16 left-1/4 w-1/2 bg-white shadow-lg rounded-md">
        <div class="flex items-center justify-between bg-gray-200 px-3 py-1 rounded-t-md">
            ...
            <div class="text-gray-700">lapid_migration-model/create-task</div>
            <div></div>
        </div>
        <div class="p-4 text-gray-900">
            <h2 class="text-2xl font-bold mb-6">Create New Task</h2>
            <form action="https://scaling-funicular-gwg6qjrxw6r2p9wq-8000.app.github.dev/tasks" method="POST" class="space-y-4">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <textarea name="description" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
                </div>
                <div class="flex space-x-4">
                    <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600">Save Task</button>
                    <a href="https://scaling-funicular-gwg6qjrxw6r2p9wq-8000.app.github.dev/tasks/" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600">Back</a>
                </div>
            </form>
        </div>
    </div>
